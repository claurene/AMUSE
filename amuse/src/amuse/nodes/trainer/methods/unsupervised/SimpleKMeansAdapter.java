...
public class SimpleKMeansAdapter extends AmuseTask implements TrainerInterface {
    ...
    public void trainModel(String outputModel) throws NodeException {
        ...
        try {
            ...
            // Train the model
            Operator modelLearner = OperatorService.createOperator("weka:W-SimpleKMeans");

            // Set the parameters
            modelLearner.setParameter("N", "" + this.cluster_number);
